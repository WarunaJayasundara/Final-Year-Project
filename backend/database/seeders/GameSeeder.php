    ...
    public function run(): void
    {
        $games = [
            [
                ...
                'description_si' => 'හැකි ඉක්මනින් ගැලපෙන යුගල සොයා ගැනීමට කාඩ්පත් හරවන්න.',
            ],
            [
            ...
            [
                ...
                'description_si' => 'තත්පර 60ක වේගවත් ගණිත අභ්‍යාසයකි. ඔබට කොපමණ ප්‍රමාණයක් විසඳිය හැකිද?',
            ],
            [
                ...
                'description_si' => 'ඉලක්ක හැඩයේ දර්පණ රූපය නොව, එහි සැබෑ භ්‍රමණය වන හැඩය තෝරන්න.',
            ],
            [
                'code' => 'selective_attention',
                'name_en' => 'Selective Attention Challenge',
                'name_si' => 'වරණීය අවධාන අභියෝගය',
            ...
            [
                ...
                'description_si' => 'ඉලක්කම් මතකය, ආපසු සිහිපත් කිරීම සහ 2-back යාවත්කාලීන කිරීම - වැඩිහිටි මට්ටමේ ක්‍රියාකාරී මතක පුහුණුව.',
            ],
            [
                ...
                'description_si' => 'දර්ශන විස්තර මතක තබාගෙන ජාල අනුක්‍රම ආපසු තට්ටු කරන්න - පර්යේෂණ මට්ටමේ දෘශ්‍ය හා අවකාශීය මතක පුහුණුව.',
            ],
            [
                'code' => 'cognitive_command_center',
                'name_en' => 'Cognitive Command Center',
                'name_si' => 'සංජානන විධාන මධ්‍යස්ථානය',
