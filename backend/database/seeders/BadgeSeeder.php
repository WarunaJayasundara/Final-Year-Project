    ...
    public function run(): void
    {
        $badges = [
            [
                ...
                'description_si' => 'ඔබේ මට්ටම් නිර්ණය පරීක්ෂණය සම්පූර්ණ කරන්න.',
                'icon' => 'footprints',
                'xp_reward' => 50,
                'coin_reward' => 20,
            ],
            [
                ...
                'description_si' => 'දින 3ක දෛනික අභ්‍යාස අඛණ්ඩතාවක් ළඟා කර ගන්න.',
                'icon' => 'flame',
                'xp_reward' => 20,
                'coin_reward' => 10,
            ],
            [
                ...
                'description_si' => 'දින 7ක දෛනික අඛණ්ඩතාවක් ළඟා කර ගන්න.',
                'icon' => 'flame',
                'xp_reward' => 50,
                'coin_reward' => 25,
            ],
            [
                ...
                'name_si' => 'සති දෙකේ ඒකාග්‍රතාව',
                'description_en' => 'Reach a 14-day practice streak.',
                'description_si' => 'දින 14ක දෛනික අඛණ්ඩතාවක් ළඟා කර ගන්න.',
                'icon' => 'flame',
                'xp_reward' => 100,
                'coin_reward' => 50,
            ],
            [
                ...
                'description_si' => 'දින 30ක දෛනික අඛණ්ඩතාවක් ළඟා කර ගන්න.',
                'icon' => 'flame',
                'xp_reward' => 250,
                'coin_reward' => 100,
            ],
            [
                ...
                'description_si' => 'ඕනෑම පරීක්ෂණ සැසියකින් 100%ක ලකුණු ලබා ගන්න.',
                'icon' => 'star',
                'xp_reward' => 30,
                'coin_reward' => 15,
            ],
            ...
            [
                ...
                'description_si' => 'IQ මට්ටම 3 වෙත ළඟා වන්න.',
                'icon' => 'trending-up',
                'xp_reward' => 60,
                'coin_reward' => 30,
            ],
            [
                ...
                'description_si' => 'වේදිකාවේ උපරිම IQ මට්ටම වන 5 වෙත ළඟා වන්න.',
                'icon' => 'crown',
                'xp_reward' => 150,
                'coin_reward' => 75,
            ],
            ...
            [
                ...
                'description_si' => 'AI විභාග සූදානම් පුරෝකථනයෙන් "සූදානම්" තත්ත්වයට ළඟා වන්න.',
                'icon' => 'check-circle',
                'xp_reward' => 60,
                'coin_reward' => 30,
            ],
